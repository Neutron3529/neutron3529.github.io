...
void train(short *t, short *w, int n, int err) {
  __m512i mm2,mm3,mm0=_mm512_set1_epi16((short)err),mm1=_mm512_set1_epi16(1);
  for (int i=0; i<n; i+=32) {
    //    movdqa xmm2, [rdx+rcx*2] ; w[i]
    mm2=_mm512_load_si512((__m512i*)(w+i));
    //    movdqa xmm3, [rax+rcx*2] ; t[i]
    mm3=_mm512_load_si512((__m512i*)(t+i));
    //    paddsw xmm3, xmm3      ; t[i]*2
    mm3=_mm512_adds_epi16(mm3,mm3);
    //    pmulhw xmm3, xmm0      ; t[i]*err*2 >> 16
    mm3=_mm512_mulhi_epi16(mm3,mm0);
    //    paddsw xmm3, xmm1      ; (t[i]*err*2 >> 16)+1
    mm3=_mm512_adds_epi16(mm3,mm1);
    //    psraw xmm3, 1          ; (t[i]*err*2 >> 16)+1 >> 1
    mm3=_mm512_srai_epi16(mm3,1);
    //    paddsw xmm2, xmm3      ; w[i] + xmm3
    mm2=_mm512_adds_epi16(mm2,mm3);
    //    movdqa [rdx+rcx*2], xmm2
    _mm512_store_si512((__m512i*)(w+i),mm2);
  }
}
#else
